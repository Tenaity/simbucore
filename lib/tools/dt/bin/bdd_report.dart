...
final String iPhone8 = "iPhone8";
final String iPhone13Pro = "iPhone13Pro";
final String pixel5 = "pixel5";

final String iPhone8UUID = "6FB30977-E11C-4001-A749-4403F4B3E261";
final String iPhone13ProUUID = "A49BC245-DB99-4E14-9870-131C8976CA2C";
final String iPhone14ProUUID = "0A2BDB91-D9C7-4897-94EA-C48A499CCE19";
final String pixel5EmulatorID = "emulator-5554";
final String gherkinReportPath = Directory.current.path + "/integration_test/reports/integration_response_data.json";
...
Future<void> runFeatureTests(String deviceId) async {
  ...
  stdout.writeln("      Cmd: flutter drive -driver=test_driver/integration_test_feature_driver.dart --target=integration_test/gherkin_suite_recovery_test.dart -d " + deviceId);
...
void createCucumberJsReport(String device) {
  ...
  var formattedReportPath = Directory.current.path + "/integration_test/gherkin/reporters/cucumber-html/digestableme.json";
  ...
  '''
{
  ...
  var metaPath = Directory.current.path + "/integration_test/gherkin/reporters/cucumber-html/meta.json";
...
Future<void> viewCucumberJsReport(String path) async {
  ...
  Directory.current = path + "/integration_test/gherkin/reporters/cucumber-html";
