/*
  Device Adapter - Adapts cross platform device information e.g. can get Device name on iOS, Android or web.
...
class DeviceAdapter {
  ...
  Future<Device> getDevice() async {
    if (kIsWeb) {
      ...
      var agent = browser.browserAgent;

      return Device(
        model: "",
        name: browser.browser,
        version: "$version - $agent",
        identifier: browser.hashCode.toString(),
      );
    }
