...
import 'package:simbucore/app/event_action/provider/action_registrar_provider.dart';
...
final eventStoreProvider = Provider<EventStore>(
  (ref) => EventStore(EventBusService(EventBus(), ref.read(actionRegistrarProvider))),
);
